...
function about() {
  ...
  pieces.innerHTML = `
    <div id="info" class="board shadow">
      ...
      <p id="love">
  <a href="">Nối từ</a> - 
  Made with <i id="heart" class="las la-heart"></i> by <a href="http://nnbnh.github.io">NguyênA5-project</a>
</p>
<p id="love" class="contact-box">
  <a href="https://www.facebook.com/crygen.03" target="_blank" class="contact-item">
    <i class="lab la-facebook-square"></i> Facebook
  </a>

  <a href="https://m.me/crygen.03" target="_blank" class="contact-item">
    <i class="lab la-facebook-messenger"></i> Messenger
  </a>

  <a href="https://zalo.me/" target="_blank" class="contact-item">
    <i class="las la-phone"></i> Zalo
  </a>

  <a href="https://discord.com/" target="_blank" class="contact-item">
